...
function d7_children_14_process_html(&$variables) {
...
function d7_children_14_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function d7_children_14_button($variables) {
 ...
 */
function d7_children_14_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function d7_children_14_menu_local_task($variables) {
 ...
 */
function d7_children_14_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function d7_children_14_node_preview($variables) {
  $node = $variables['node'];
