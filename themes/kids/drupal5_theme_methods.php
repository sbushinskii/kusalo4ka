...
function d7_children_14_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function d7_children_14_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function d7_children_14_feed_icon($url) {
 ...
 */
function d7_children_14_comment_wrapper($content, $type = null) {
  static $node_type;
