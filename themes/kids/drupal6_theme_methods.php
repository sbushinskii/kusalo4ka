...
function d7_children_14_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function d7_children_14_feed_icon($url, $title) {
 ...
 */
function d7_children_14_preprocess_comment_wrapper(&$vars) {
 ...
 */
function d7_children_14_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function d7_children_14_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function d7_children_14_button($element) {
...
*/
function d7_children_14_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function d7_children_14_node_preview($node) {
